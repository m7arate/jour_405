...
The headline is not justified because the margin of error could bring the support >50% and therefore majority support is not present. A better alternate headline would be: 'Poll Show Support Split for New City Policy'

Each person submits their own answers to the questions.

t-test: Used in hypothesis testing. Measures standard errors between means in two samples. Larger t statsistic means that eroor is more likely to exist. 
...
Statistical evidence suggests that the new transit line has led to an increase in housing prices in local neighborhoods. There are other factors that contribute to increased housing prices nationwide, including general economic uncertainty. 

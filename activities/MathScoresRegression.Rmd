...
**There is a slightly positive correlation between FARMS and math test scores. **
...
**It is worth looking into, if there was seemingly no correlation it wouldn't be worth it.**
...
**Most of the largest differences come from schools who are performing worse than expected.**
...
**The model says that this is true. Despite the trend line going upwards, schools with more students on FARMS tend to do worse on standardizes math tests. I would like to note that correlation does not always equal causation, and it more likely comes from the lack of food security at home rather than at school.**

...
**Task 3: Write your answer here: Private colleges have the highest mean and median SAT scores. They also have the tightest standard deviation. Community schools generally have the lowest mean and median with the widest spread for standard deviation. Public schools are in the middle.**
...
**There is a notable difference in SAT scores across college types. Community colleges are ranked lower while private collages are higher. Public and private schools are closer, with public schools being lower. There is a significant difference (400) between private and community schools.**

**Private schools statistically admit applicants with highest SAT scores.**

**According to a study conducted by ___, private college applicants statistically have the highest SAT scores when compared to applicants from public university and community colleges. There is a 367 point difference between private schools and community colleges, and 74 point difference between private and public schools.**

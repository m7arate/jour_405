...
**ANSWER HERE**: Baltimore stands out as particularly diverse. 
...
**ANSWER HERE**: Summerfield, and that's because it has a Black population that eclipses the rest of the races.
...
**ANSWER HERE**: Cities with the lowest hisp_prob have one race that is dramatically higher than the rest. 
...
**ANSWER HERE**: Lake shore is the least diverse with a massive white population that overtakes the rest. Lake shore is closer to the bay and just outside of Baltimore.
...
**ANSWER HERE**: The most diverse city in Maryland, Langley Park

Langley park has a nearly equal ratio across all demographics, sitting right at the edge of DC and Prince George's County. 

I would then contact officials in the city as well as any individuals there who might have something to say.

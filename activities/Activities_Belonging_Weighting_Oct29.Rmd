...
**Write your answer here: The scales were not designed to be objective according to the appendix, which means that with differing perspectives could sway responses.**
...
1. What is the range of weights in this dataset? **Write your answer here: the lowest is 0.23 and the highest is 3.04.**

2. What does it mean when a respondent has a weight of 0.23? What about 3.04? **Write your answer here: Lower weight means less statistical significance.**

3. Why might some respondents be weighted more heavily than others? **Write your answer here: In order to match the end statistics to the rest of their population more accurately.**
...
1. Which voter category shows the biggest difference between weighted and unweighted results? **Write your answer here: Rarely/never**
...
3. Why do you think these differences exist? What does this tell us about who might be over or under-represented in the sample? **Write your answer here: These differences exist because of the weighting. The rarely/never group seems to be over represented in the survey.**

...
**Yes, all the scores are above the prior mean.**
...
**I can initially see that the mean has risen and the standard deviation has shrunk. This means that the scores have risen and become more consistent. My question would be what are these programs doing differently than past programs?**
...
**New reading program shows increased scores across classrooms.**
...
**Hypotheses:**
Null: The new reading program have no effect on reading scores.
Alternative: The new reading program improve reading scores.

```{r}
# Set the significance level for your test
alpha_level <- 10000 # Replace with the appropriate value
...
**The p-value is extremely small, 0.00003435, which supports the idea that the mean is greater than 72.6.**
...
New school reading programs show improvement.

Third grade reading scores have showsn a statistical improvement after new reading programs were implemented across the district. There has been an almost 4% improvement to scores on average.
...
Other metrics that might help in assesing reading performance would be number of books finished or something like that.

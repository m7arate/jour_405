...
**WRITE YOUR ANSWER HERE**: Car theft rates spiked from 2023 to 2024 and has largely renmained the same..
...
- **Null Hypothesis (H0)**:   The mean is the same pre and post spike.

- **Alternative Hypothesis (H1)**: The mean is different pre and post spike.
...
**WRITE YOUR ANSWER HERE**: Statistically mean theft rates are higher and therefore significant.
...
**WRITE YOUR ANSWER HERE**: The Tukey test shows the spike year is significantly higher than both before and after it, and the post-spike period is still significantly higher than the pre-spike period. Car theft rates did not return to pre-spike levels.

Head: Car Theft Rates Stay Elevated After 2023 Spike

Lede: Prince George's crime rates are still elevated after the 2023 spike. This might be a lasting increase rather than a random jump. 

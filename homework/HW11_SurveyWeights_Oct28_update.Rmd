...
**College students are busy. It also depends on the location that the survey is conducted.**
...
**College students are more likely to vote according to study.**
...
**The percentage of yes from those with high school or less went down.**

2. Why might the weighted results be considered more accurate than the unweighted results?

**Weighted results more accurately reflect the actual population and therefore are more accurate.**
...
**Where the weights are derived from and if that source is credible.**

...
**WRITE ANSWERS HERE: it seems to be trending downwards.** 
...
- What does the 95% confidence interval show here? **WRITE ANSWER HERE: It means that 95% of the of tested intervals would contain the true mean.**

- What figure(s) accurately reflects the number of car thefts in a typical month? **WRITE ANSWER HERE: The mean and the standard deviation. While a month might not align exactly to the mean, they generally fall under one standard deviation from the mean.**

- Propose a headline about the trend in car thefts that is focused on the present and future, but informed by the data you see above. **WRITE ANSWER HERE: Monthly car thefts have fallen below the average in recent months.**
...
Given the above chart, is the difference between the two periods statistically significant? Can we reject the null hypothesis? **WRITE ANSWER HERE: No, but there is still a noticiable drop. We can reject the null hypothesis.**

How would you revise your headline from Task 6, if at all? What would you tell your editor, and what would you expect her to ask you? **WRITE ANSWER HERE: Monthly car thefts have fallen below the average in recent months, but not significantly. I'll tell her that there wasn't a huge difference in the two halves. She'd probably ask how I know, then I'd show her the graps.**
